...
Includes lots of examples with application to cosmology, general relativity, numerical relativity, hydrodynamics, Maxwell equations, and hyperbolic conservation laws.`,
	...
	new ProjectThumb({
		...
		tags:['astronomy','opengl','luajit','langfix'],
	}),
	new ProjectThumb({
...
How did the modern state of software become so apathetic?`,
	...
	new ProjectThumb({
		...
		tags:['luajit','geography','astronomy'],
	}),
	new ProjectThumb({
...
const projectThumbs = {
	['thenumbernine.github.io'] : {branch:'master', pic:"bank-steam/ss1.png"},
	['python-lua'] : {branch:'master'},
	['http-lua'] : {branch:'master'},
	['numo9'] : {branch:'master', pic:"2048x2/font.png"},
	['lua-gui'] : {branch:'master'},
	['fftrpg-numo9'] : {branch:'master', pic:"font.png"},
	['ff6lib-lua'] : {branch:'master'},
	['lua-dist'] : {branch:'master', pic:"default-icon.png"},
	['earthquake-shear-lines'] : {branch:'master', pic:"earth-color.png"},
	['MathWorksheets'] : {branch:'master', pic:"Antigravity_1.png"},
	['tripletriadminmax'] : {branch:'master'},
	['js-util'] : {branch:'master'},
	['glapp-js'] : {branch:'master', pic:"pic.png"},
	['lua-ffi-wasm'] : {branch:'master'},
	['luaffifb'] : {branch:'chris'},
	['lua-ext'] : {branch:'master'},
	['lua-ffi-bindings'] : {branch:'master'},
	['lua-imgui'] : {branch:'master'},
	['lua-sdl'] : {branch:'master'},
	['earth-magnetic-field-lua'] : {branch:'master', pic:"earth.png"},
	['langfix-lua'] : {branch:'master'},
	['lua-integrate'] : {branch:'master'},
	['solarsystem-lua'] : {branch:'master', pic:"images/1.png"},
	['lua-url'] : {branch:'master'},
	['cryptobot'] : {branch:'master', pic:"latest/public/play.png"},
	['lua-websocket'] : {branch:'master'},
	['lua-plot2d'] : {branch:'master', pic:"font.png"},
	['symmath-lua'] : {branch:'master'},
	['hydro-cl-lua'] : {branch:'master'},
	['struct-lua'] : {branch:'master'},
	['bank-numo9'] : {branch:'master', pic:"animsheet.png"},
	['zeta3d-lua'] : {branch:'master', pic:"res/noise.png"},
	['farm-game'] : {branch:'master', pic:"splash.png"},
	['lua-image'] : {branch:'master', pic:"tests/test.png"},
	['include-lua'] : {branch:'master'},
	['polynomial-complex-roots'] : {branch:'master'},
	['chinese-checkers-on-sphere-lua'] : {branch:'master'},
	['mesh-lua'] : {branch:'master', pic:"meshes/hue.png"},
	['lua-thread'] : {branch:'master'},
	['SDL-in-LuaJIT-android'] : {branch:'master'},
	['LuaJIT-android-lib'] : {branch:'master'},
	['LuaJIT-android'] : {branch:'master', pic:"icon.png"},
	['lua-gl'] : {branch:'master', pic:"tests/src.png"},
	['lua-wgpu'] : {branch:'master'},
	['lua-audio'] : {branch:'master'},
	['lua-cl'] : {branch:'master'},
	['lua-clip'] : {branch:'master'},
	['autoupdate-lua'] : {branch:'master'},
	['zip-lua'] : {branch:'master'},
	['lua-interpreter'] : {branch:'master'},
	['lua-bit'] : {branch:'master'},
	['solver-lua'] : {branch:'master'},
	['vec-ffi-lua'] : {branch:'master'},
	['vec-lua'] : {branch:'master'},
	['lua-template'] : {branch:'master'},
	['lua-stl'] : {branch:'master'},
	['lua-parser'] : {branch:'master'},
	['lua-matrix'] : {branch:'master'},
	['luafilesystem'] : {branch:'unicode'},
	['lua-gnuplot'] : {branch:'master', pic:"images/example1.png"},
	['complex-lua'] : {branch:'master'},
	['lua-app3d'] : {branch:'master'},
	['cl-cpu-lua'] : {branch:'master'},
	['lua-ffi-c'] : {branch:'master'},
	['black-hole-skymap'] : {branch:'master', pic:"menu.png"},
	['cayley-dickson'] : {branch:'master'},
	['n-points-lua'] : {branch:'master'},
	['super-metroid-randomizer-lua'] : {branch:'master', pic:"screenshots/pic1.png"},
	['chess-on-manifold-lua'] : {branch:'master', pic:"pic.png"},
	['lua-plot3d'] : {branch:'master', pic:"font.png"},
	['TacticsLua'] : {branch:'master', pic:"textures/gui/background-units.png"},
	['lan-scanner'] : {branch:'master'},
	['lua-lua'] : {branch:'master'},
	['lua-vk'] : {branch:'master'},
	['SDLLuaJIT-android'] : {branch:'master', pic:"app/src/main/assets/gl/tests/src.png"},
	['Bible-android'] : {branch:'master', pic:"icon.png"},
	['lua-java'] : {branch:'master'},
	['git-lua'] : {branch:'master'},
	['lua-make'] : {branch:'master'},
	['lua-ips'] : {branch:'master'},
	['kart-lua'] : {branch:'master', pic:"maps/map1/height.png"},
	['zeta-lua'] : {branch:'master', pic:"base/res/font.png"},
	['force-directed-graph-lua'] : {branch:'master'},
	['geographic-charts-lua'] : {branch:'master', pic:"earth-color.png"},
	['lua-ffi-for-js'] : {branch:'master'},
	['seashell-lua'] : {branch:'master', pic:"pics/pic1.png"},
	['volume-renderer-lua'] : {branch:'master'},
	['tetris-attack-lua'] : {branch:'master', pic:"cursor.png"},
	['following-fdtd-lessons'] : {branch:'master', pic:"out.png"},
	['lua-neuralnet'] : {branch:'master'},
	['3x3-interpolation'] : {branch:'master'},
	['browser3d-lua'] : {branch:'master', pic:"pages/cube.png"},
	['surface-from-connection-lua'] : {branch:'master', pic:"docs/conn numeric vs analytic.png"},
	['lua-math'] : {branch:'master'},
	['moldwars'] : {branch:'master'},
	['lua-metric'] : {branch:'master', pic:"images/gaussian.png"},
	['gravitational-waves-lua'] : {branch:'master'},
	['SphericalHarmonicGraphs'] : {branch:'master', pic:"images/image1.png"},
	['sand-attack'] : {branch:'master', pic:"tex/splash.png"},
	['pong-lua'] : {branch:'master', pic:"ball.png"},
	['lambda-cdm-lua'] : {branch:'master', pic:"screenshot.png"},
	['EinsteinFieldEquationSolution'] : {branch:'master', pic:"images/earth profile d_dr mass.png"},
	['efesoln-cl-lua'] : {branch:'master', pic:"images/pic.png"},
	['space-game-js'] : {branch:'master'},
	['kart-js'] : {branch:'master', pic:"maps/map1/height.png"},
	['ad-verse'] : {branch:'master', pic:"adtex-staging/your_ad_here-64x64.png"},
	['poisson-gpu-js'] : {branch:'master'},
	['hydrodynamics-js'] : {branch:'master', pic:"background.png"},
	['wavefunction'] : {branch:'master', pic:"menu.png"},
	['topple-js'] : {branch:'master'},
	['4d-renderer-js'] : {branch:'master', pic:"images/screenshot.png"},
	['universe'] : {branch:'master', pic:"close.png"},
	['conway-life-webgl'] : {branch:'master'},
	['octonion-multiplication-table-js'] : {branch:'master', pic:"images/screenshot.png"},
	['thomas-precession'] : {branch:'master', pic:"BlueMarble.png"},
	['metric'] : {branch:'master', pic:"menu.png"},
	['time-dilation'] : {branch:'master', pic:"menu.png"},
	['socialbrowsing'] : {branch:'master', pic:"cursor.png"},
	['solarsystem'] : {branch:'master', pic:"colorForTemp.png"},
	['gl-js'] : {branch:'master'},
	['prime-spiral-lua'] : {branch:'master', pic:"pi-spiral.png"},
	['nbody-gpu-lua'] : {branch:'master', pic:"pics/pic1.png"},
	['convert-to-8x8x4bpp'] : {branch:'master', pic:"results/color 0 tiles.png"},
	['earth-transport-network'] : {branch:'master', pic:"docs/1.png"},
	['Topple'] : {branch:'master', pic:"images/1048576.png"},
	['seismographic-stations'] : {branch:'master', pic:"earth-color.png"},
	['rule110-lua'] : {branch:'master', pic:"pic.png"},
	['dungeons-n-munchers-lua'] : {branch:'master', pic:"hero.png"},
	['line-integral-convolution-lua'] : {branch:'master', pic:"pic.png"},
	['lua-gameapp'] : {branch:'master'},
	['refraction-to-match-black-hole'] : {branch:'master'},
	['waves-in-curved-space'] : {branch:'master', pic:"pics/pic1.png"},
	['MatMulKernelTest'] : {branch:'master', pic:"comparison-min-double.png"},
	['DFCrack'] : {branch:'master'},
	['noaa_flares'] : {branch:'master'},
	['mimetypes-lua'] : {branch:'master'},
	['query-simbad'] : {branch:'master'},
	['noaa_drap'] : {branch:'master'},
	['webtactics'] : {branch:'master', pic:"client/gender/female.png"},
	['lua-csv'] : {branch:'master'},
	['lua-selfmodify'] : {branch:'master'},
	['grem-lua'] : {branch:'master'},
	['lua-netrefl'] : {branch:'master'},
	['texture-atlas'] : {branch:'master'},
	['sphere-grid-lua'] : {branch:'master'},
	['chompman'] : {branch:'master', pic:"pic1.png"},
	['lua_to_js'] : {branch:'master'},
	['ascii-art-vpl'] : {branch:'master'},
	['elf-lua'] : {branch:'master'},
	['tensor-lua'] : {branch:'master'},
	['space-filling-curve'] : {branch:'master'},
	['mono-lua'] : {branch:'master'},
	['smooth-graph-lua'] : {branch:'master'},
	['lua-simplexnoise'] : {branch:'master'},
	['fibonacci-modulo'] : {branch:'master', pic:"pics/1001.png"},
	['stupid-text-rpg'] : {branch:'master'},
	['stat-lua'] : {branch:'master'},
	['leftargs-lua'] : {branch:'master'},
	['lua_to_batch'] : {branch:'master'},
	['lua-threadmanager'] : {branch:'master'},
	['netcdf-lua'] : {branch:'master'},
	['lua-bignumber'] : {branch:'master'},
	['lua-svg'] : {branch:'master'},
	['earth-surface-time-dilation-lua'] : {branch:'master'},
	['htmlparser-lua'] : {branch:'master'},
	['lua-resourcecache'] : {branch:'master'},
	['modules-lua'] : {branch:'master'},
	['require-graph-lua'] : {branch:'master'},
	['WebGPUApp'] : {branch:'master'},
	['VulkanApp'] : {branch:'master'},
	['Tensor'] : {branch:'master'},
	['webserver'] : {branch:'master'},
	['GLApp'] : {branch:'master'},
	['ImGuiCommon'] : {branch:'master'},
	['SDLApp'] : {branch:'master'},
	['ncurses-lua'] : {branch:'master'},
	['c-h-parser-lua'] : {branch:'master'},
	['zeckendorff'] : {branch:'master'},
	['circle-on-curved-surface'] : {branch:'master'},
	['numerical-relativity-codegen'] : {branch:'master'},
	['fullcallstack-lua'] : {branch:'master'},
	['luajit-pureffi'] : {branch:'main', pic:"examples/vulkan/capsadmin.png"},
	['worldgen'] : {branch:'master', pic:"out.png"},
	['quantize-tiles'] : {branch:'master'},
	['identify-blobs'] : {branch:'master'},
	['Ganesha'] : {branch:'main'},
	['lua-imguiapp'] : {branch:'master'},
	['bank-game-js'] : {branch:'master', pic:"bank.png"},
	['faraday-cage'] : {branch:'master', pic:"phi-out-raw.png"},
	['geo-center-earth'] : {branch:'master', pic:"continent-mask-3.png"},
	['VectorFieldDecomposition-lua'] : {branch:'master'},
	['cfdmeshlua'] : {branch:'master', pic:"pic.png"},
	['celestial-gravitomagnetics-lua'] : {branch:'master', pic:"images/averageDistanceToSun vs orbitalPeriod.png"},
	['2048_3D'] : {branch:'master'},
	['pi-z-curve'] : {branch:'master', pic:"pi-binary.png"},
	//['teukolsky-waves'] : gh: Git Repository is empty. (HTTP 409)},
	['html-resource-updater'] : {branch:'master'},
	['Image'] : {branch:'master', pic:"test/res/test.png"},
	['regge-lua'] : {branch:'master', pic:"pic.png"},
	['SoftwareRenderer'] : {branch:'master'},
	['DGTest'] : {branch:'master'},
	['oop-in-c'] : {branch:'master'},
	['preproc-lua'] : {branch:'master'},
	['lua-profile'] : {branch:'master'},
	['emoji-lua'] : {branch:'master'},
	['stupidrpg-game-js'] : {branch:'master', pic:"icons/cancel.png"},
	['elemental'] : {branch:'master', pic:"app_elemental.png"},
	['NeuralNet'] : {branch:'master'},
	['LuaCxx'] : {branch:'master'},
	['Common'] : {branch:'master'},
	['luajitsocket'] : {branch:'master'},
	['lua-local-default'] : {branch:'master'},
	['lua-0-based'] : {branch:'master'},
	['sql-lua'] : {branch:'master'},
	['mario-kart-wii-stat-picker'] : {branch:'master'},
	['DominionCardChooser'] : {branch:'master', pic:"images/icons-18-black.png"},
	['swinekeeper'] : {branch:'master'},
	['clip'] : {branch:'main'},
	['ImageMetrics'] : {branch:'master'},
	['lua128'] : {branch:'master', pic:"doc/osi-certified-72x60.png"},
	['springs-meh-lua'] : {branch:'master'},
	['GLCxx'] : {branch:'master'},
	['gpu_from_pde-lua'] : {branch:'master'},
	['wii-sdl-luajit'] : {branch:'master', pic:"dist/icon.png"},
	['HydrodynamicsGPU'] : {branch:'master', pic:"res/test-solid.png"},
	['Profiler'] : {branch:'master'},
	['CFDMesh'] : {branch:'master', pic:"res/layout.png"},
	['Hydrodynamics'] : {branch:'master'},
	['wii-luajit'] : {branch:'master'},
	['tinyddsloader'] : {branch:'master'},
	['hydro-cl-senr'] : {branch:'master'},
	['all-tensor-muls'] : {branch:'master'},
	['tracking-youtube'] : {branch:'master'},
	['obs-buildvideo'] : {branch:'master'},
	['GalacticRotationCurves_2021Ludwig'] : {branch:'master'},
	['lua-gles2'] : {branch:'master'},
	['ProjectEuler'] : {branch:'master'},
	['mmo-js'] : {branch:'master', pic:"cursor.png"},
	['lua-multigrid-poisson'] : {branch:'master'},
	['magnetometer-js'] : {branch:'master'},
	['ImageProcessing'] : {branch:'master', pic:"lua-blurred-unblurred-cg.png"},
	['FFTactics_BlenderPlugin'] : {branch:'master', pic:"example.png"},
	['NBodyGPU'] : {branch:'master'},
	['thirteen-lua'] : {branch:'master'},
	['poker-lua'] : {branch:'master'},
	['VolumeTest'] : {branch:'master'},
	['upwork_1629364234171568129'] : {branch:'master'},
	['CellularGPU'] : {branch:'master'},
	['Relativity'] : {branch:'master'},
	['reverse_string_c_cpp_rust'] : {branch:'master'},
	['date-noooticer-lua'] : {branch:'master'},
	['AsteroidsSPH'] : {branch:'master'},
	['CubicCurveFonts'] : {branch:'master'},
	['Solver'] : {branch:'master'},
	['CLCommon'] : {branch:'master'},
	['scrabble-solver'] : {branch:'master'},
	['Parallel'] : {branch:'master'},
	['CLCPU'] : {branch:'master'},
	['CxxAsLua'] : {branch:'master'},
	['multiplicative-persistence'] : {branch:'master'},
	['loop-quantum-gravity'] : {branch:'master'},
	['Sod_exact'] : {branch:'master', pic:"results.png"},
	['cards-lua'] : {branch:'master'},
	['lua-jfnk'] : {branch:'master'},
	['dungeons-n-munchers-js'] : {branch:'master'},
	['zeta-js'] : {branch:'master'},
	['biggun-quake'] : {branch:'master'},
};
for (const [repoName,repo] of Object.entries(projectThumbs)) {
	...
	if (p && !p.img && repo.pic) {
		...
		p.img = 'https://raw.githubusercontent.com/'+user+'/'+repoName+'/refs/heads/'+repo.branch+'/'+repo.pic;
	}
}
